...
const connectedSocket = parsedQuery.get('rpc') || config.PROVIDER_SOCKET1
///
...
const SubstrateContextProvider1 = props => {
...
// prop typechecking
SubstrateContextProvider1.propTypes = {
  socket: PropTypes.string,
}

const useSubstrate1 = () => useContext(SubstrateContext)
const useSubstrateState1 = () => useContext(SubstrateContext).state

export { SubstrateContextProvider1, useSubstrate1, useSubstrateState1 }
